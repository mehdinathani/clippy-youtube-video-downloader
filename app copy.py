...
# Page config
st.set_page_config(page_title="Clippy your YouTube Downloader", page_icon="🎬", layout="wide")
...
if url:
    ...
    # Quick Best Quality (video+audio)
    st.markdown("### 🚀 Quick Download")
    if st.button("Download Best Quality Available"):
        download_and_offer(url, "bestvideo+bestaudio/best", merge=True)
